...
> | [`../keycloak-poc.md`](../keycloak-poc.md) | 進階課綱：13 個 Module，協定原理到生產部署 |
> | **本目錄** | **可建置執行的整合實作** — 對應進階課綱的 [Module 7：應用程式整合實戰](../keycloak-poc.md#module-7應用程式整合實戰) |
>
> 建議順序：先用 `../README.md` 建立體感 → 讀本目錄看真實專案怎麼落地 → 回到 `../keycloak-poc.md` 補齊生產議題。
